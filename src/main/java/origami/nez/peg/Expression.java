...
public abstract class Expression extends AbstractList<Expression> implements StringCombinator {
	...
	static abstract class PBinary extends Expression {
		...
		public void formatPair(String delim, StringBuilder sb) {
			if (left instanceof Expression.PChoice) {
				sb.append("(");
				left.strOut(sb);
				sb.append(")");
			} else {
			...
			sb.append(delim);
			if (right instanceof Expression.PChoice) {
				sb.append("(");
				right.strOut(sb);
				sb.append(")");
			} else {
	...
	public final static class PNonTerminal extends Expression {
		...
		public final boolean equals(Object o) {
			if (o instanceof PNonTerminal) {
				return name.equals(((PNonTerminal) o).name) && grammar == ((PNonTerminal) o).getGrammar();
			}
			return false;
		}
		...
		public final String getUniqueName() {
			return this.grammar.getUniqueName(this.name);
		}
	...
	public static class PRepetition extends PUnary {
		...
		@Override
		public void strOut(StringBuilder sb) {
			this.formatUnary(null, isOneMore() ? "+" : "*", sb);
		}
	...
	public static class PLinkTree extends PUnary {
		...
		@Override
		public void strOut(StringBuilder sb) {
			formatUnary((this.label != null) ? "$" + this.label + "(" : "$(", ")", sb);
		}
	}
	...
	public static class PSymbolPredicate extends PFunction<String> {
		...
		public PSymbolPredicate(NezFunc op, String param, PNonTerminal pat, Object ref) {
			...
			int l = param.indexOf('+');
			if (l > 0) {
				symbol = param.substring(l + 1);
				param = param.substring(0, l);
			}
			table = Symbol.unique(param);
		}
	...
	public static class PTrap extends PTerm {
		...
		public final boolean equals(Object o) {
			if (o instanceof Expression.PTrap) {
				...
				return trapid == l.trapid && this.uid == l.uid;
			}
			return false;
		}
	...
	public static class Duplicator<A> extends AbstractExpressionVisitor<A> {
		...
		public Expression visitNonTerminal(PNonTerminal e, A a) {
			if (e.getGrammar() != base && base != null) {
				String lname = e.getLocalName();
				// if (pname.isTerminal()) {
				// pname = base.newTerminalName(pname.name);
				// } else {
				// pname = base.newProductionName(pname.getLocalName());
				// }
				return new Expression.PNonTerminal(base, e.isLeftRecursion, lname, ref(e));
			}
			if (enableFullDuplication) {
				return new Expression.PNonTerminal(e.getGrammar(), e.isLeftRecursion, e.getLocalName(), ref(e));
			}
			return e;
		}
		...
		public Expression visitByte(Expression.PByte e, A a) {
			if (enableFullDuplication) {
				return new Expression.PByte(e.byteChar, ref(e));
			}
			return e;
		}
		...
		public Expression visitByteSet(Expression.PByteSet e, A a) {
			if (enableFullDuplication) {
				return new Expression.PByteSet(e.bits, ref(e));
			}
			return e;
		}
		...
		public Expression visitPair(Expression.PPair e, A a) {
			Expression e0 = dup(e, 0, a);
			Expression e1 = dup(e, 1, a);
			if (e0 != e.get(0) || e1 != e.get(1) || enableFullDuplication) {
				return Expression.newSequence(e0, e1, ref(e));
			}
			return e;
		}
		...
		public Expression visitChoice(Expression.PChoice e, A a) {
			...
			if (isModified || enableFullDuplication) {
				return new Expression.PChoice(en, ref(e));
			}
			return e;
		}
		...
		public Expression visitDispatch(Expression.PDispatch e, A a) {
			...
			if (isModified || enableFullDuplication) {
				return new Expression.PDispatch(en, e.indexMap, ref(e));
			}
			return e;
		}
		...
		public Expression visitOption(Expression.POption e, A a) {
			Expression e0 = dup(e, 0, a);
			if (e0 != e.get(0) || enableFullDuplication) {
				return new Expression.POption(e0, ref(e));
			}
			return e;
		}
		...
		public Expression visitRepetition(Expression.PRepetition e, A a) {
			Expression e0 = dup(e, 0, a);
			if (e0 != e.get(0) || enableFullDuplication) {
				return new Expression.PRepetition(e0, e.min, e.max, ref(e));
			}
			return e;
		}
		...
		public Expression visitAnd(Expression.PAnd e, A a) {
			Expression e0 = dup(e, 0, a);
			if (e0 != e.get(0) || enableFullDuplication) {
				return new Expression.PAnd(e0, ref(e));
			}
			return e;
		}
		...
		public Expression visitNot(Expression.PNot e, A a) {
			Expression e0 = dup(e, 0, a);
			if (e0 != e.get(0) || enableFullDuplication) {
				return new Expression.PNot(e0, ref(e));
			}
			return e;
		}
		...
		public Expression visitTree(Expression.PTree e, A a) {
			Expression e0 = dup(e, 0, a);
			if (e0 != e.get(0) || enableFullDuplication) {
				return new Expression.PTree(e.folding, e.label, e.beginShift, e0, e.tag, e.value, e.endShift, ref(e));
			}
			return e;
		}
		...
		public Expression visitLinkTree(Expression.PLinkTree e, A a) {
			Expression e0 = dup(e, 0, a);
			if (e0 != e.get(0) || enableFullDuplication) {
				return new Expression.PLinkTree(e.label, e0, ref(e));
			}
			return e;
		}
		...
		public Expression visitTag(Expression.PTag e, A a) {
			if (enableFullDuplication) {
				return new Expression.PTag(e.tag, ref(e));
			}
			return e;
		}
		...
		public Expression visitReplace(PReplace e, A a) {
			if (enableFullDuplication) {
				return new Expression.PReplace(e.value, ref(e));
			}
			return e;
		}
		...
		public Expression visitDetree(PDetree e, A a) {
			Expression e0 = dup(e, 0, a);
			if (e0 != e.get(0) || enableFullDuplication) {
				return new Expression.PDetree(e0, ref(e));
			}
			return e;
		}
		...
		public Expression visitSymbolScope(Expression.PSymbolScope e, A a) {
			Expression e0 = dup(e, 0, a);
			if (e0 != e.get(0) || enableFullDuplication) {
				return new Expression.PSymbolScope(e.funcName, e.param, e0, ref(e));
			}
			return e;
		}
		...
		public Expression visitSymbolAction(Expression.PSymbolAction e, A a) {
			Expression e0 = dup(e, 0, a);
			if (e0 != e.get(0) || enableFullDuplication) {
				return new Expression.PSymbolAction(e.funcName, e.param, (PNonTerminal) e0, ref(e));
			}
			return e;
		}
		...
		public Expression visitSymbolPredicate(Expression.PSymbolPredicate e, A a) {
			Expression e0 = dup(e, 0, a);
			if (e0 != e.get(0) || enableFullDuplication) {
				return new Expression.PSymbolPredicate(e.funcName, e.param, (PNonTerminal) e0, ref(e));
			}
			return e;
		}
		...
		public Expression visitScan(Expression.PScan e, A a) {
			Expression e0 = dup(e, 0, a);
			if (e0 != e.get(0) || enableFullDuplication) {
				return new Expression.PScan(e.param, e0, ref(e));
			}
			return e;
		}
		...
		public Expression visitRepeat(Expression.PRepeat e, A a) {
			Expression e0 = dup(e, 0, a);
			if (e0 != e.get(0) || enableFullDuplication) {
				return new Expression.PRepeat(e0, ref(e));
			}
			return e;
		}
		...
		public Expression visitIf(Expression.PIfCondition e, A a) {
			if (enableFullDuplication) {
				return new Expression.PIfCondition(e.param, ref(e));
			}
			return e;
		}
		...
		public Expression visitOn(Expression.POnCondition e, A a) {
			Expression e0 = dup(e, 0, a);
			if (e0 != e.get(0) || enableFullDuplication) {
				return new Expression.POnCondition(e.param, e0, ref(e));
			}
			return e;
		}
		...
		public Expression visitTrap(Expression.PTrap e, A a) {
			if (enableFullDuplication) {
				return new Expression.PTrap(e.trapid, e.uid, ref(e));
			}
			return e;
		}
	...
	public static class Rewriter<A> extends ExpressionVisitor<Expression, A> {
		...
		@Override
		public Expression visitPair(Expression.PPair e, A a) {
			e.set(0, rewrite(e, 0, a));
			e.set(1, rewrite(e, 1, a));
			return e.desugar();
		}
