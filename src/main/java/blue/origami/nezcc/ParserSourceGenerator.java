...
//
// public abstract class ParserSourceGenerator extends
// ParserGenerator<StringBuilder, String> {
//
...
//
// @Override
// protected void declConst(String typeName, String constName, int arraySize,
// String literal) {
//
// String decl = "";
...
// this.writeSection(String.format("%s%s = %s%s", decl, constName, literal,
// this.s(";")));
// } else {
// constName = this.arrayName(typeName, constName);
// typeName = this.arrayType(typeName, constName);
// this.writeSection(
// String.format("%s%s = %s%s", decl, this.formatParam(typeName, constName),
// literal, this.s(";")));
// }
// }
//
...
// }
//
// protected String formatSignature(String ret, String funcName, String[]
// params) {
// if (ret == null || this.useDynamicTyping()) {
// return String.format("%s %s(%s)", this.s("function"), funcName,
// this.emitParams(params));
// } else {
// return String.format("%s %s %s(%s)", this.s("function"), ret, funcName,
// this.emitParams(params));
// }
// }
//
...
//
// @Override
// protected void declFunc(int acc, String ret, String funcName, String[]
// params, Block<String> block) {
// this.writeSection(String.format("%s %s", this.formatSignature(ret, funcName,
// params), this.s("{")));
// this.incIndent();
...
// sb.append(String.format("%s(%s) %s", elseIf ? this.s("else if") :
// this.s("if"), expr, this.s("{")));
// this.incIndent();
...
// return String.format("%s%s%s = %s%s", this.s(self), this.s("."),
// this.s(name), expr, this.s(";"));
// }
//
// @Override
...
// final int n = i;
// this.emitIfStmt(block, this.emitOp(this.V("result"), "==", this.vInt(i)),
// elseIf, () -> {
