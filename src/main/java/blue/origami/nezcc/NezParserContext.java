...
//
// public NezParserContext(String inputs, int memo, NewFunc<T> newFunc,
/// SetFunc<T> setFunc) {
...
// }
// }
// this.tree = this.newFunc.newTree(tag, this.inputs, ppos, (this.pos + shift) -
/// ppos, objectSize, value);
// if (objectSize > 0) {
// int n = 0;
...
// public T newTree(String tag, byte[] inputs, int pos, int len, int size,
/// String value);
// }
//
...
// public boolean match(NezParserContext<?> px, String label, int ppos, Object
/// option);
// }
//
...
// }
//
// public static KeyValueTree newTree1(String tag, byte[] inputs, int pos, int
/// len, int size, String value) {
// if (size == 0) {
// return new KeyValueTree(tag, value != null ? value : new String(inputs, pos,
/// len));
// }
// return new KeyValueTree(tag, new KeyValueTree[size]);
// }
//
// public static KeyValueTree setTree1(KeyValueTree parent, int n, String label,
/// KeyValueTree child) {
...
// }
//
// static NezParserContext<KeyValueTree> getSampleParserContext(String[] a, int
/// memo) {
...
// }
//
// static final <T> boolean pLink(NezParserContext<T> px, ParserFunc<T> f,
/// String label) {
// T tree = px.tree;
// TreeLog<T> treeLog = px.treeLog;
// if (!f.match(px)) {
...
// }
//
// static final <T> boolean pMemo(NezParserContext<T> px, ParserFunc<T> f, int
/// mp) {
// int pos = px.pos;
...
// }
//
// static final <T> boolean pMemoT(NezParserContext<T> px, ParserFunc<T> f, int
/// mp) {
// int pos = px.pos;
