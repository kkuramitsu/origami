...
// this.showResource("/blue/origami/nezcc/pyparser-man.txt", "$cmd$",
...
//
// @Override
// protected String emitNewToken(String tag, String inputs, String pos, String
/// epos) {
// return String.format("(%s, (%s[%s:%s]).decode('utf-8'))", tag, inputs, pos,
/// epos);
// }
//
// @Override
...
//
// @Override
// protected String emitSetTree(String parent, String n, String label, String
/// child) {
// StringBuilder block = this.beginBlock();
