...
// }
//
// private CodeTree(Symbol tag, OSource source, long pos, int len, int size,
/// Object value) {
...
// CodeTree t = new CodeTree(this.getTag(), this.getSource(),
...
// throw new ErrorCode(this, TFmt.YY1_does_not_exist_in_YY2, label,
/// this.getTag());
// }
//
// @Override
// public Object apply(Symbol tag, OSource s, int spos, int epos, int nsubs,
/// Object value) {
