...
// }
//
// public final static Method loadMethod(Class<?> c, String name, Class<?>...
/// parameterTypes) {
// try {
// return c.getMethod(name, parameterTypes);
// } catch (NoSuchMethodException | SecurityException e) {
// throw new ErrorCode(null, "undefined method: %s.%s(%s) by %s", c, name,
/// parameterTypes, e);
// }
// }
//
...
// }
//
// public static Constructor<?> loadConstructor(Class<?> c, Class<?>...
/// parameterTypes) {
// try {
// return c.getDeclaredConstructor(parameterTypes);
// } catch (NoSuchMethodException | SecurityException e) {
// throw new ErrorCode(null, "undefined method: %s(%s) by %s", c,
/// parameterTypes, e);
// }
// }
//
...
// }
//
// public static void listMatchedMethods(OTypeSystem ts, Class<?> c, String
/// name, List<OMethodHandle> l,
