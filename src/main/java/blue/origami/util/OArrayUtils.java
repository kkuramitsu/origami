...
public interface OArrayUtils {
	...
	public default <T> T[] append(T first, @SuppressWarnings("unchecked") T... params) {
		@SuppressWarnings("unchecked") //
		T[] v = (T[]) Array.newInstance(params.getClass().getComponentType(), params.length + 1);
		v[0] = first;
	...
	public default <T> T[] slice(T[] params, int start, int end) {
		@SuppressWarnings("unchecked") //
		T[] v = (T[]) Array.newInstance(params.getClass().getComponentType(), end - start);
	...
	public default <T> T[] insert(T[] params, int n, T val) {
		...
		@SuppressWarnings("unchecked") //
		T[] a = (T[]) Array.newInstance(params.getClass().getComponentType(), params.length + 1);
	...
	public default <T, S> S[] map(T[] a, S[] b, java.util.function.Function<T, S> f) {
