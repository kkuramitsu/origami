...
public class BreakCode extends OJumpCode<String> {

	private OEnv localEnv = null;

	public BreakCode(OEnv env, String label, OCode expr) {
		super(env, label, expr);
		this.localEnv = env;
	}

	public BreakCode(OEnv env, String label) {
		super(env, label);
	}

	public BreakCode(OEnv env) {
		this(env, null);
	}
