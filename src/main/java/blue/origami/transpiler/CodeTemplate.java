...
//
// public class CodeTemplate extends CodeMap implements NameInfo {
//
// protected final String template;
//
// public CodeTemplate(String name, Ty returnType, Ty[] paramTypes, String
// template) {
...
// this.paramTypes = Arrays.stream(this.paramTypes).map(x ->
