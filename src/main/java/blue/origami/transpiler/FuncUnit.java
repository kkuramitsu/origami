...
// return Arrays.stream(this.getParamSource()).map(t ->
// t.getString()).toArray(String[]::new);
// }
//
...
// }
//
// public default Code typeCheck(final Env env0, FunctionContext fcx, VarDomain
// dom, Code code0) {
...
// return new ErrorCode(this.getSource(), TFmt.ambiguous_type__S,
// this.getReturnType());
// }
// }
// return code;
