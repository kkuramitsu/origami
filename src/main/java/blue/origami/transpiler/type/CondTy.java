...
// if (this.pred) {
// return this.condTy.match(sub, codeTy, logs) && this.baseTy.match(sub, codeTy,
// logs);
// }
// return !this.condTy.match(sub, codeTy, logs) && this.baseTy.match(sub,
// codeTy, logs);
// }
//
// @Override
// public <C> C mapType(TypeMapper<C> codeType) {
// return codeType.mapType(this.baseTy.keyOfMemo());
// }
//
// @Override
