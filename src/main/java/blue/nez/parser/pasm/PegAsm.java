...
public class PegAsm {
	...
	static Object opValue(PAsmInst inst, int p) {
	...
	public static void stringfy(PAsmInst inst, StringBuilder sb) {
	...
	public static PAsmInst joinPoint(PAsmInst inst) {
		if (inst != null) {
			inst.joinPoint = true;
		}
		return inst;
