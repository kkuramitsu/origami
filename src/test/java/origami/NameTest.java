...
// this.check("linenums$?", env.findNameHint("linenums$?"),
// "Option[List[Int]$]");
// }
//
// //
...
// OConsole.println(p + " " + o + "" + OConsole.color(OConsole.Red, " != " +
// o2));
// assert (Objects.equals("" + o, "" + o2)) : p + " " + o + "" +
// OConsole.color(OConsole.Red, " != " + o2);
// } else {
// OConsole.println(p + " " + o + "" + OConsole.color(OConsole.Blue, " == " +
// o2));
// }
// }
//
