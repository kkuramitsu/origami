...
// runScript("sum(a: Int) = if a == 0 then 0 else a + sum(a-1);sum",
// "Int->Int");
...
// OConsole.color(OConsole.Red, checked));
// assert (checked.equals(ty.toString())) : ty + " != " + checked;
// } else {
// System.out.printf("%s %s :: %s\n", TFmt.Checked, text,
// OConsole.color(OConsole.Blue, ty.toString()));
// }
// }
//
...
// System.out.printf("%s %s :: %s\n", TFmt.Checked, text, ty);
// } else {
// System.out.printf(OConsole.color(OConsole.Yellow, "FIXME %s %s :: %s !=
// %s\n"), TFmt.Checked, text, ty,
// checked);
// }
// }
