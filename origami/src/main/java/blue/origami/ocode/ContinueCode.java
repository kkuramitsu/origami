...
import blue.origami.asm.OrigamiContinueException;
import blue.origami.lang.OEnv;

public class ContinueCode extends OJumpCode<String> {

	private OEnv localEnv = null;

	public ContinueCode(OEnv env, String label, OCode expr) {
		super(env, label, expr);
		this.localEnv = null;
	}

	public ContinueCode(OEnv env, String label) {
		super(env, label);
	}
